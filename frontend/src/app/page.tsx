...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="z-10 relative bg-[#0a0a0a] border border-white/10 p-12 rounded-3xl backdrop-blur-xl shadow-2xl max-w-md w-full text-center">
        <h1 className="text-5xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-white/60 mb-4">Chronos</h1>
